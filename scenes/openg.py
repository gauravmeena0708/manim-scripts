...
class OpenGLIntro(Scene):
    def construct(self):
        ...
        #Run by typing manim -pqm .\openg.py --renderer=opengl --write_to_movie OpenGLIntro

#it can make interactive based on mouse or key
#run by 
#manim -pqm .\openg.py --renderer=opengl InteractiveRadius
